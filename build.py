...
def build(
    ...
    # Resolved here rather than in the signature: as a default it ran once at
    # import time, so importing this module required torch to be installed.
    ...
    for plugin in PLUGINS:
        NINJA_STR += PLUGIN_TEMPLATE.substitute(
            {
                "plugin": plugin,
