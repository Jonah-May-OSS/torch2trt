...
try:
    ...
    def create_reflection_pad_2d_plugin(
    ...
    def convert_reflection_pad(ctx):
        ...
        plugin = create_reflection_pad_2d_plugin(
            module.padding[0], module.padding[1], module.padding[2], module.padding[3]
        )
        layer = ctx.network.add_plugin_v2([input_trt], plugin)
        output._trt = layer.get_output(0)

except Exception:
    # The plugin converters are optional; without the plugin library built,
    # registration simply does not happen.
    pass
